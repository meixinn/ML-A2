...
os.environ['SUMO_HOME'] = 'C:/Users/nicol/Downloads/sumo'
...
class TrafficEnv(Env):
    ...
    def _step(self, action): # Execute the given action in the simulation and return observation, reward, done, info
    ...
    def _reset(self):      # Reset the simulation and return initial observation
        self.stop_sumo()
