...
from traffic_light import TrafficLightTwoWay
import os
...
class TrafficEnvSimple(TrafficEnv):
    def __init__(self, mode="gui"):
        ...
        netfile = os.path.join(basepath, "second.net.xml")
        routefile = os.path.join(basepath, "second.rou.xml")
        guifile = os.path.join(basepath, "view.settings.xml")
        addfile = os.path.join(basepath, "second.add.xml")
